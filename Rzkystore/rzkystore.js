...
let kingSuper = new List_items("ROKOK","SUPER-KING",1);
...
// DV -1 RELEASED 
//FEATURE DROPUP
// const ulDropUp = document.getElementsByClassName('dropdown-menu');
// function dropUp(idLink){
//   let ulList = `<li><a href="#${idLink[0].category}">${idLink[0].category}</a></li>`;
// console.log(ulList);
// }
// dropUp(listRokok);